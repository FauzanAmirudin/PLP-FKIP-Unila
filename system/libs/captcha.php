...
class gf_captcha
{
     ...
     *
     */
    public $resourcesPath = _CAPTHA_PATH . '../resources';
    ...
    /** Background color in RGBA-array */
    public $backgroundColor = array(255, 255, 255, 0);
    ...
    public function validate(string $captcha)
    {
        ...
        if (!empty($_SESSION[$this->session_var])) {
            if (strtolower($captcha) == $_SESSION[$this->session_var]) {
    ...
    protected function ImageAllocate()
    {
        ...
        if ($this->imageFormat == 'png' && function_exists('imagepng')) {
            ...
            // Background color
            $this->GdBgColor = imagecolorallocatealpha(
                $this->im,
    ...
    protected function WriteText($text, $fontcfg = array())
    {
        ...
        $text_box = imagettfbbox($fontcfg['maxSize'], $this->maxRotation, $fontfile, $text);
