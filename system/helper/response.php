...
|
*/
if (!function_exists("disable_maintenance_banner")) {
	function disable_maintenance_banner()
	{
		if (!defined('GF_MAINTENANCE_BANNER_DISABLED')) {
			define('GF_MAINTENANCE_BANNER_DISABLED', TRUE);
		}
	}
}
if (!function_exists("error_page")) {
	function error_page($code)
	{
		/* get date and time */
		ob_start();
		include(GF_APP_PATH . DIRECTORY_SEPARATOR . "view" . DIRECTORY_SEPARATOR . "error" . DIRECTORY_SEPARATOR . $code . ".php");
...
if (!function_exists("error204")) {
	function error204()
	{
		header('HTTP/1.0 204 Forbidden');
		exit;
	}
}
