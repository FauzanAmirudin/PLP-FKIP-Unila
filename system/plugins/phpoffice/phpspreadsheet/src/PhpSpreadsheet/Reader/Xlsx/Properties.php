...
class Properties
{
    ...
    public function readCoreProperties($propertyData): void
    {
        ...
        if (is_object($xmlCore)) {
            ...
            $this->docProps->setCreated(strtotime((string) self::getArrayItem($xmlCore->xpath('dcterms:created')))); //! respect xsi:type
            $this->docProps->setModified(strtotime((string) self::getArrayItem($xmlCore->xpath('dcterms:modified')))); //! respect xsi:type
