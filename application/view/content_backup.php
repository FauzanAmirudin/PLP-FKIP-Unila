...
<?php
	...
	$fullpage = ['home', 'about', 'contact', 'frontPage', 'gallery', 'informasi', 'detailinformasi'];
...
<content class="<?php echo $is_dashboard ? 'dashboard-container' : ''; ?>">
		...
		****************************************************************************-->
		<section id="sidebar-wraper" class="dashboard-sidebar-wrapper">
			<ul class="dashboard-sidebar-menu">
				<li class="sidebar-item <?php echo ($page == 'loby') ? 'active' : ''; ?>">
					<a href="?page=loby" title="Halaman Anda">
				...
				<li class="sidebar-item <?php echo ($page == 'biodata') ? 'active' : ''; ?>">
					<a href="?page=biodata" title="Biodata">
				...
				<?php } ?>
				<li class="sidebar-item <?php echo ($page == 'jadwal') ? 'active' : ''; ?>">
					<a href="?page=jadwal" title="Jadwal Kegiatan">
				...
				?>
					<li class="sidebar-item <?php echo ($page == 'berkas') ? 'active' : ''; ?>">
						<a href="?page=berkas" title="Pendaftaran / Unduh Berkas">
					...
					<li class="sidebar-item <?php echo ($page == 'penempatan') ? 'active' : ''; ?>">
						<a href="?page=penempatan" title="Penempatan">
					...
					<li class="sidebar-item <?php echo ($page == 'laporan') ? 'active' : ''; ?>">
						<a href="?page=laporan" title="Laporan">
				...
				if (is_level("Admin, Monitor, DPL")) { ?>
					<li class="sidebar-item <?php echo ($page == 'cekLaporan') ? 'active' : ''; ?>">
						<a href="?page=cekLaporan">
							<svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
							<span class="sidebar-label">Laporan Peserta</span>
						</a>
					</li>
				<?php }
				if (is_level("Admin, Monitor")) { ?>
					<li class="sidebar-item <?php echo ($page == 'monitor') ? 'active' : ''; ?>">
						<a href="?page=monitor" title="Monitor">
					...
					<li class="sidebar-item <?php echo ($page == 'daftarpeserta') ? 'active' : ''; ?>">
						<a href="?page=daftarpeserta" title="Data Peserta">
				...
				if (is_level("Admin, Operator")) { ?>
					<li class="sidebar-item <?php echo ($page == 'validatepeserta') ? 'active' : ''; ?>">
						<a href="?page=validatepeserta" title="Validasi">
							...
							<span class="sidebar-label">Validasi Peserta</span>
						</a>
					</li>
					<li class="sidebar-item <?php echo ($page == 'sitesetting') ? 'active' : ''; ?>">
						<a href="?page=sitesetting" title="Pengaturan Web">
					...
					<li class="sidebar-item <?php echo ($page == 'resetpassword') ? 'active' : ''; ?>">
						<a href="?page=resetpassword" title="Reset Password Peserta">
				...
				<li class="sidebar-item <?php echo ($page == 'account') ? 'active' : ''; ?>">
					<a href="?page=account" title="Pengaturan">
						<svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
				...
				<?php
				if (is_level("Admin, Operator")) { ?>
					<li class="sidebar-item <?php echo ($page == 'versionhistory') ? 'active' : ''; ?>">
						<a href="?page=versionhistory">
							<svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
			...
			<div class="dashboard-sidebar-footer">
				<a href="logout.php" class="dashboard-logout-btn" title="Keluar">
	...
	?>
	<section id="mainContent" class="<?php echo (is_login() && !in_array($page, $fullpage)) ? 'dashboard-main-content' : ''; ?>">
		<!--************************************************************************
		Main content starts here
		************************************'****************************************-->
		<?php

		$pageFile = GF_CONTROLLER_PATH . DIRECTORY_SEPARATOR . "page/$page.php";

		if ($page == "home" || $page == "") {
			require GF_CONTROLLER_PATH . DIRECTORY_SEPARATOR . "page/frontPage.php";
		} else {
			if (file_exists($pageFile)) {
				require $pageFile;
			} else {
				require GF_CONTROLLER_PATH . DIRECTORY_SEPARATOR . "page/404.php";
			}
		}
		?>
	</section>
