          ...
          <tr>
            ...
            <td>
              <div class="actions-flex">
                ...
                <button type="button" onclick="openDeleteModal(<?php echo $info['ID']; ?>, '<?php echo htmlspecialchars(addslashes($info['JUDUL']), ENT_QUOTES); ?>')" title="Hapus" class="btn-square btn-delete-red">
