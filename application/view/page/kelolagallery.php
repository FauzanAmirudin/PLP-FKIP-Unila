        ...
        <div class="gallery-card-admin">
          ...
          <div class="gallery-info-box">
            ...
            <div class="gallery-actions">
              ...
              <button type="button" onclick="openDeleteModal(<?php echo $photo['ID']; ?>, '<?php echo htmlspecialchars(addslashes(!empty($photo['KETERANGAN']) ? mb_strimwidth($photo['KETERANGAN'], 0, 30, '...') : 'foto ini'), ENT_QUOTES); ?>')" title="Hapus" class="btn-delete-sm">
