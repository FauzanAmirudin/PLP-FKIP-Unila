...
<html>
	...
	<div class="isi">
		<div class="pass-foto">
			<?php if(isset($npm)){echo '<img src="uploads/foto-profile/'.$tahundaftar.'/'.$npm.'.jpg" width="100px" height="125px">';}else{echo '<br><br><a> Pass Foto </a><br><a> 3 cm x 4 cm</a>';} ?>
	   	</div>
    	<div class="biodata">
	    <a>Dengan ini saya:</a>
    		<div class="row">
		...
		<div class="sign">
            ...
            <div class="sign-right">
                <p><b>Pendaftar</b></p><br><br><br><h5 class="materai">materai 10.000</h5><br><a><?php if(isset($nama)){echo $nama;}else{$n=1; while($n<=35){echo ".";$n++;}} ?></a><br><a>NPM. <?php if(isset($npm)){echo $npm;} ?></a>
            </div>
		</div>
